...
print("Ex2:", z.list_objects())
print("Ex3:", z.list_users())
print("Ex4:", z.list_types())
# print("Ex5: %s (socrates)" % z.list_associations_entity("socrates"))
# print("Ex5: {} (darwin)".format(z.list_relations("darwin")))
